...
class NewtonInterpolationPolynomial(object):
    ...
    def select_nodes(self):
        """ Выбор новых массивов узлов в диапазоне n+1 от ближайшей к аргументу точке """
...
def main():
    ...
    st.markdown("**Тема:** Построение и программная реализация алгоритма полиномиальной интерполяции табличных функций")
    st.markdown("""
    **Цель работы:** Получение навыков построения алгоритма интерполяции таблично заданных функций полиномом Ньютона.
    ...
    x = c1.number_input("Введите значение аргумента - x:", min_value=.0, max_value=1., value=.525, format="%.3f")
